...
urlpatterns = [
    ...
    path('customer-delete/<slug:slug>/', CustomerDeleteView.as_view(), name='customer-delete'),
    path('customer-edit/<slug:slug>/', CustomerUpdateView.as_view(), name='customer-edit'),
